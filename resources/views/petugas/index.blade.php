            ...
            <div class="card-body">
              <table id="dataTables" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <td>
                  <div class="btn-group">
                      <a href="{{ route('petugas.show', $value->id) }}" class="btn-sm btn-info">
                        Detail
                      </a>
                      <a href="{{ route('petugas.edit', $value->id) }}" class="btn-sm btn-warning" style="margin-left: 8px;">
                        Edit
                      </a>
                      <form action="{{ route('petugas.destroy', $value->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <a href="" type="submit" class="btn-sm btn-danger" style="margin-left: 10px;" data-toggle="modal" data-target="#exampleModal">Delete</a>
                      </form>
                      </div>
                    </td>
                  </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Anda yakin ingin menghapus data petugas?</p>
      </div>
